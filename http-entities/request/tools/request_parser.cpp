...
RequestParser::RequestParser(const char* request_raw):
...
const char* RequestParser::get_request_line_raw() const
{
	return request_line_raw_;
}
const char* RequestParser::get_request_headers_raw() const
{
	return request_headers_raw_;
}
const char* RequestParser::get_request_body_raw() const
{
